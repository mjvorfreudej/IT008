...
namespace Bai08
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            // Vẽ kim giờ (hình thoi)
            DrawHand(g, (hour + minute / 60.0) * 30 - 90, radius * 0.5, 14, Color.White, true);

            // Vẽ kim phút (hình thoi)
            DrawHand(g, (minute + second / 60.0) * 6 - 90, radius * 0.7, 12, Color.White, true);

            // Vẽ kim giây (đường thẳng)
            DrawHand(g, second * 6 - 90, radius * 0.85, 1, Color.White, false);
